...
use App\Http\Middleware\GuestLimit;
...
/* ---------- GOST DIJAGNOZA ---------- */
Route::middleware(GuestLimit::class)->group(function(){
...
|--------------------------------------------------------------------------
*/
Route::prefix('advisor')->name('advisor.guest.')->middleware(GuestLimit::class)->group(function () {
...
/*
|--------------------------------------------------------------------------
| POLOVNJACI (advisor) – registrovani korisnik
|--------------------------------------------------------------------------
*/
