...
<div class="max-w-md mx-auto p-10 bg-black translate-y-1/4 rounded-lg shadow-lg">
    ...
    <form action="{{ route('password.update') }}" method="POST">
        ...
        <div class="mb-4 relative">
            <input type="password" name="password" placeholder="Nova šifra" id="password" required
                   class="input-field bg-gray-700">
        ...
        <!-- Confirm Password -->
        <div class="mb-4 relative">
            <input type="password" name="password_confirmation" placeholder="Ponovi šifru" id="password_confirmation" required
                   class="input-field bg-gray-700">
            <span class="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer toggle-password">
                <svg class="w-5 h-5 text-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24"
             xmlns="http://www.w3.org/2000/svg">
