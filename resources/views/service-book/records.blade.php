...
<div class="page-format relative">
    <div class="flex flex-col h-full">
        ...
        <div class="flex-wrap flex p-2 md:p-4 md:p-8">
            @foreach($serviceRecords as $record)
                <div class="flex flex-col border-orange radius-10 p-2 md:p-8 relative m-0 md:m-4 service-card">
                    <div class="flex justify-between">
                    <div class="block font-bold flex items-center">
                        {{ $record->description }}
                    </div>
                    ...
                    <div class="block md:flex justify-between items-end mt-4 mb-4">
